  ...
  const getLocais = async () => {
    ...
    const url =
      token && isListaLocaisPage
        ? `${import.meta.env.VITE_URL_API}/locais/usuario` // Se na página '/listaLocal', usa '/locais/usuario'
        : `${import.meta.env.VITE_URL_API}/dashboard/locais`; // Se não usa '/dashboard/locais' para \public e \home
